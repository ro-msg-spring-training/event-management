...
insert into event values (2, 'msg Party', 'Intern Party', false, '2019-10-18', '2019-10-18', 30,'Boom schakalaka',true, 'BYOB', 'creator',timestamp '2020-10-18 20:30:00.00',timestamp '2020-10-18 23:30:00.00',5,'Best choices for your fun time!');
insert into event values (3, 'Chess Club Meeting', 'For Chess Lovers', true, '2020-06-17', '2020-06-17', 40,'Feel free to join',true, 'New competition will be announced', 'creator',timestamp '2020-06-17 12:30:00.00',timestamp '2020-06-17 16:30:00.00',15,'For every 2 tickets bought you get one for free!');
