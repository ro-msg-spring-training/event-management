...
insert into event values (2, 'msg Party', 'Intern Party', false, timestamp '2019-10-18', timestamp '2019-10-20', 30,'Boom schakalaka',true, 'BYOB', 'creator',timestamp '2020-10-18 20:30:00.00',timestamp '2020-10-18 23:30:00.00',5,'Best choices for your fun time!');
insert into event values (3, 'Chess Club Meeting', 'For Chess Lovers', true, timestamp '2020-06-17', timestamp '2020-06-19', 40,'Feel free to join',true, 'New competition will be announced', 'creator',timestamp '2020-06-17 12:30:00.00',timestamp '2020-06-17 16:30:00.00',15,'For every 2 tickets bought you get one for free!');
...
insert into event values (6, 'Most sarmale ever made', 'Breaking records', true, timestamp '2021-09-20', timestamp '2021-09-20', 200,'Breaking the record for most cabbage rolls made',true, 'Bring your friends and eat for free', 'creator',timestamp '2021-09-20 8:30:00.00',timestamp '2021-09-20 23:30:00.00',12,'Tickets can also be bought from out partners and on www.ticketsforsale.com');
insert into event values (7, 'Fruit Party', 'Nothing but fruits, for real', false, timestamp '2019-09-17', timestamp '2019-09-17', 200,'Healthiest party in Cluj',true, 'NO MEAT!!!', 'creator',timestamp '2019-09-17 18:30:00.00',timestamp '2019-09-17 23:30:00.00',2,'You can buy tickets exclusively online and we have a no return policy!');
insert into event values (8, 'Star Trek Party', 'Themed Party', true, timestamp '2020-12-17', timestamp '2020-12-17', 200,'Nerdiest party in Cluj 2',true, 'Best costume wins free drinks', 'creator',timestamp '2020-12-17 18:30:00.00',timestamp '2020-12-17 23:30:00.00',5,'You get now 15% off for every ticket category if you buy 2 or more tickets!');
