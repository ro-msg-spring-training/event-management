            ...
            <FormGroup className={`${classesLogin.loginform} loginformResponsive`}>
                ...
                <div className="field">
                    <p className={classesLogin.alignLeftDiv}>
                        <a href="/forgotpassword" className={classesLogin.link}>Forgot password?</a>
                    </p>
                </div>
                <FormErrors error={error} />

                <Button variant="contained" type="submit" onClick={onSubmit} className={`${classes.buttonStyle2} ${classes.buttonStyle3} ${classesLogin.loginButton}`} >Login</Button>

                <div className="field">
                    <p className="control">
                        Don't have an account?
                <a href="/register" className={classesLogin.link}> Register here</a>
                    </p>
                </div>
            </FormGroup>
