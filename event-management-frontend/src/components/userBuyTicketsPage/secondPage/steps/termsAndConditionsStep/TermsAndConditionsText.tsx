...
export const termsAndConditionsText = <>
  ...
  AG (hereinafter referred to as “msg systems”).<br />
  ...
  Services of msg systems apply.<br />
  ...
  annulment of this written form requirement.<br />
  1.5 The provisions of a contract have priority over any conflicting
  provisions of these General Terms and Conditions.<br />
  ...
  presentation of an invoice.<br />
  3. Subject of a Contract for the Licensing of Standard<br />
  <h4>Software</h4>
  ...
  result from the user documentation.<br />
  ...
  systems in separate contracts for an equivalent remuneration.<br />
  3.4 msg systems shall deliver the contract software to the customer
  as provided in the quotation.<br />
  ...
  systems, in an electronic, printable form on a suitable data carrier.<br />
</>